...
I created this report while following R Ladies Freiburg's "Guided Tidy Tuesday" meetup on 2021-06-08. Today's data can be found [here]() and comes from the [Coffee Quality Database](https://github.com/jldbc/coffee-quality-database); it includes reviews of multiple features of coffee beans from around the world.
